...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    renderer.domElement.style.pointerEvents = 'none' // IMPORTANT: don’t block clicks
    ...
    // --- Window-based pointer tracking so it works under any overlay DOM
    ...
    if (interactive) {
      window.addEventListener('pointermove', handlePointerMoveWindow, { passive: true })
